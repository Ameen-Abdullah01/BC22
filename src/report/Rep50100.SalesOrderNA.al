report 50100 "New Sales Order NA"
{
    DefaultLayout = RDLC;
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = './NewSalesOrderNA.rdl';
    Caption = 'NewSales-Order';
    ApplicationArea = all;
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            //Manasa  AGT 21_04_23
            column(item_Image; AdvertisementMaster_G.Image) { }
            column(item_Text; AdvertisementMaster_G."Item Description") { }
            column(item_URL; AdvertisementMaster_G.URL) { }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(SalesLine; "Integer")
                    {
                        ...
                        column(TempSalesLineShipDate; TempSalesLine."Shipment Date")
                        {
                        }
                        column(Grav_Delivery; TempSalesLine."Grav Delivery")
                        {

                        }
                        column(TempSalesLineCrossRefNo; TempSalesLine."Item Reference No.")
                        {
                        }
                    ...
                    var
                        myInt: Integer;
                    begin
                        // if ItemImg.Get("Sales Header"."Item No") then begin
                        //     //if (ItemImg."Active-Sal Ord." = true) and ("Sales Header"."Posting Date" <= ItemImg."Effective Date") then begin
                        //     ItemImg.CalcFields(ItemImg.Image);
                        //ItemText := ItemImg.Text;
                        //end;
                        // end;
                    end;   //Manasa
                }
            ...
            begin
                ...
                AdvertisementMaster_G1.Reset();   //Manasa
                AdvertisementMaster_G1.SetFilter("Active-Sal Ord.", '%1', true);
                // If Cust_L.get("Sell-to Customer No.") then
                //     AdvertisementMaster_G1.SetRange("Cust. Category Code", Cust_L."Cust. Category Code");
                //AdvertisementMaster_G1.SetRange("Cust No.", Cust_L."No.");
                If AdvertisementMaster_G1.FindFirst() then Begin
                    SalesHeader_L.Reset();
                    SalesHeader_L.SetRange("Document Type", "Sales Header"."Document Type"::Order);
                    SalesHeader_L.SetRange("No.", "Sales Header"."No.");
                    SalesHeader_L.SetFilter("Posting Date", '%1..%2', AdvertisementMaster_G1."Effective From", AdvertisementMaster_G1."Effective To");
                    If SalesHeader_L.FindFirst() then begin
                        AdvertisementMaster_G.SetRange("Item Description", AdvertisementMaster_G1."Item Description");
                        if AdvertisementMaster_G.FindSet() then
                            AdvertisementMaster_G.Image := AdvertisementMaster_G.Image;
                    end;
                end;
            End;
    ...
    var
        AdvertisementMaster_G: record "Advertisement-Master";
        AdvertisementMaster_G1: record "Advertisement-Master";
        TaxLiable: Decimal;
