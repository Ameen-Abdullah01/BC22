xmlport 57100 "Export Record Link"
{
    Format = VariableText;
    ...
    schema
    {
        textelement(Root)
        {
            tableelement("Records Links Temp"; "Record Link")
            {
                XmlName = 'RecordLink';
                ...
                begin
                    ...
                    if RecID.TableNo <> 0 then begin
                        ...
                        if "Records Links Temp".Note.HASVALUE then begin
                            ...
                            //The following line was adjusted to avoid the error: Invalid data encountered in stream, unable to read text
