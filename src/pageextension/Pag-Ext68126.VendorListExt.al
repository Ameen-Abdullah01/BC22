pageextension 68126 VendorList extends "Vendor List"
{
    actions
    {
        addafter(Email)
            ...
            repeat
                ...
                if RecordLink.FindSet() then
                    repeat
                        ...
                        TempExcelBuffer.AddColumn(RecLinkMgt.ReadNote(RecordLink), false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
